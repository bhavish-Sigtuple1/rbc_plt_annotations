...
model_path = "/Users/bhavish/rbc_plt_annotations/rbc_plt_annotations/Models/rbc_retic_iter_1.onnx"
input_folder = "/Users/bhavish/Downloads/untitled folder"
test_img_dir = f"{input_folder}/Retic_data"
...
class_mapping = {"0": "nrbc", "1": "plt", "2": "rbc", "3": "retic", "4": "wbc"}
...
class_confidence_thresholds = {
    0: 0.0,  # Threshold for class 'nrbc'
    1: 0.0,  # Threshold for class 'plt'
    2: 0.0,  # Threshold for class 'rbc'
    3: 0.0,  # Threshold for class 'retic'
...
def save_prediction_to_coco_json(image_data, output_json_path):
    ...
    coco_json = {
        ...
        "licenses": [],
        "categories": [
            {"id": 1, "name": "nrbc", "supercategory": "cell"},
            {"id": 2, "name": "plt", "supercategory": "cell"},
            {"id": 3, "name": "rbc", "supercategory": "cell"},
            {"id": 4, "name": "retic", "supercategory": "cell"},
